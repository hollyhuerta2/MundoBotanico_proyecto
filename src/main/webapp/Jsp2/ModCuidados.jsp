<%@ page import="modelo.CuidadoPlan" %><%--@elvariable id="cuidadoPlan" type="modelo.CuidadoPlan"--%>
<%--
...
<html>
<head>
    <title>Modificar cuidados</title>
  <style>
    body{
...
<body>
<div id="cuadro">
    <h1>Modificar cuidados</h1>
     <div class="form-container">
             <form action="../SvModificarCuidado" method="post">
